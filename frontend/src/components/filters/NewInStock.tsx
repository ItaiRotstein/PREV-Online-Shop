        ...
        <>
            ...
            <div className="py-4 border-b border-gray-300">
                <div className="flex items-center mb-4">
                    <input id="new-in" type="checkbox" checked={byNewIn} onChange={() => filterDispatch({ type: "FILTER_BY_NEWIN" })} className="w-5 h-5 text-blue-600 bg-gray-100 rounded cursor-pointer" />
                    <label htmlFor="new-in" className="ms-2 text-sm font-medium text-gray-900 cursor-pointer">New In({newInCount})</label>
                </div>
                <div className="flex items-center">
                    <input id="in-stock" type="checkbox" checked={byInStock} onChange={() => filterDispatch({ type: "FILTER_BY_INSTOCK" })} className="w-5 h-5 text-blue-600 bg-gray-100 border-gray-300 rounded cursor-pointer" />
